                ...
                >
                  ...
                  {item.type === 'user' && (
                    <div className="w-full h-full relative group rounded-md overflow-hidden border border-white/5">
                      <img src={item.data.photoURL || `https://api.dicebear.com/7.x/avataaars/svg?seed=${item.data.id}`} alt="user cover" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-40 transition-opacity duration-700 group-hover:scale-105" />
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 flex items-end gap-3 sm:gap-4 transform group-hover:translate-y-[-4px] transition-transform duration-300">
                        <img src={item.data.photoURL || `https://api.dicebear.com/7.x/avataaars/svg?seed=${item.data.id}`} alt="avatar" className={`rounded-xl border-2 border-dbd-red shadow-2xl object-cover ${large ? 'w-16 h-16 sm:w-20 sm:h-20' : 'w-10 h-10 sm:w-12 sm:h-12'}`} />
